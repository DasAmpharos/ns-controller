...
from ns_shiny_hunter.legends_za.scripts.soft_reset.script import SoftReset
from ns_shiny_hunter.legends_za.scripts.terrakion import TerrakionScript
...
def main(host: str, port: int, source: int, resets: int) -> None:
    ...
    try:
        with FrameGrabber(source, imshow=True) as frame_grabber:
